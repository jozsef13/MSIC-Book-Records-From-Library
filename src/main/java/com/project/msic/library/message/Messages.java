...
public abstract class Messages {
	...
	public static final String DELETE_AUTHOR_WARN_TEXT = "Are you sure you want to delete the author? Books with this author will not be deleted.";
	...
	public static final String DELETE_CATEGORY_WARN_MESSAGE = "Are you sure you want to delete the category? Books in this category will not be deleted.";
	...
	public static final String PUBLISHER_DELETE_WARN_MESSAGE = "Are you sure you want to delete the publisher? Books with this publisher will not be deleted.";
